<?php
	// List - Title
	$font_family_title_list		= $module->get_setting( 'font_family_title_list' )->get_data();
	...
	$text_color_title_list		= $module->get_setting( 'text_color_title_list' )->get_rgb( $module->get_setting( 'text_color_title_list' )->get_data() );
	
	// List - Excerpt
	$font_family_excerpt_list	= $module->get_setting( 'font_family_excerpt_list' )->get_data();
	...
	$font_size_excerpt_list		= $module->get_setting( 'font_size_excerpt_list' )->get_data();
	$line_height_excerpt_list	= $module->get_setting( 'line_height_excerpt_list' )->get_data();
	$text_color_excerpt_list	= $module->get_setting( 'text_color_excerpt_list' )->get_rgb( $module->get_setting( 'text_color_excerpt_list' )->get_data() );
	
	// List - Read More
	$font_family_more_list		= $module->get_setting( 'font_family_more_list' )->get_data();
	...
	$font_size_more_list		= $module->get_setting( 'font_size_more_list' )->get_data();
	$line_height_more_list		= $module->get_setting( 'line_height_more_list' )->get_data();
	$text_color_more_list		= $module->get_setting( 'text_color_more_list' )->get_rgb( $module->get_setting( 'text_color_more_list' )->get_data() );
	
	// List - Color Settings
	$text_color_info_list		= $module->get_setting( 'text_color_info_list' )->get_rgb( $module->get_setting( 'text_color_info_list' )->get_data() );
	$highlight_color_list		= $module->get_setting( 'highlight_color_list' )->get_rgb( $module->get_setting( 'highlight_color_list' )->get_data() );
?>
