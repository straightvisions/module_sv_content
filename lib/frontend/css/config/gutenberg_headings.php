<?php
	$font_h1 = $font_family_h1 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h1 ) : false;
	$font_h2 = $font_family_h2 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h2 ) : false;
	$font_h3 = $font_family_h3 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h3 ) : false;
	$font_h4 = $font_family_h4 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h4 ) : false;
	$font_h5 = $font_family_h5 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h5 ) : false;
	$font_h6 = $font_family_h6 ? $script->get_parent()->get_module( 'sv_webfontloader' )->get_font_by_label( $font_family_h6 ) : false;
?>
...
.sv100_sv_content_wrapper h1 {
	...
	color: rgba(<?php echo $text_color_h1; ?>);
...
.sv100_sv_content_wrapper h2 {
	...
	color: rgba(<?php echo $text_color_h2; ?>);
...
.sv100_sv_content_wrapper h3 {
	...
	color: rgba(<?php echo $text_color_h3; ?>);
...
.sv100_sv_content_wrapper h4 {
	...
	color: rgba(<?php echo $text_color_h4; ?>);
...
.sv100_sv_content_wrapper h5 {
	...
	color: rgba(<?php echo $text_color_h5; ?>);
...
.sv100_sv_content_wrapper h6 {
	...
	color: rgba(<?php echo $text_color_h6; ?>);
