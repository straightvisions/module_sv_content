<div class="sv_setting_subpage">
	...
	<div class="sv_setting_flex">
		<?php
			echo $module->get_settings_component( 'font_size_title_mobile' )->form();
			echo $module->get_settings_component( 'line_height_title_mobile' )->form();
		?>
	</div>
	...
	<div class="sv_setting_flex">
		<?php
			echo $module->get_settings_component( 'font_family_excerpt' )->form();
			echo $module->get_settings_component( 'font_size_excerpt' )->form();
			echo $module->get_settings_component( 'text_color_excerpt' )->form();
			echo $module->get_settings_component( 'line_height_excerpt' )->form();
		?>
	</div>
    <div class="sv_setting_flex">
		<?php
	...
	<div class="sv_setting_flex">
		<?php
			echo $module->get_settings_component( 'font_size_excerpt_mobile' )->form();
			echo $module->get_settings_component( 'line_height_excerpt_mobile' )->form();
		?>
	</div>
	...
	<div class="sv_setting_flex">
		<?php
			...
			echo $module->get_settings_component( 'text_color_info' )->form();
		?>
	</div>
